...
import * as fromCreatePage    from '@/modules/app/modules/organisations/reducers/create-page.reducer';
import * as fromOrganisations from '@/modules/app/modules/organisations/reducers/organisations.reducer';
