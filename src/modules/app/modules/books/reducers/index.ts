...
import * as fromSearch     from '@/modules/app/modules/books/reducers/search.reducer';
import * as fromBooks      from '@/modules/app/modules/books/reducers/books.reducer';
import * as fromCollection from '@/modules/app/modules/books/reducers/collection.reducer';
